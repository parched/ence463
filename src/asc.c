...
int main(void)
{
	...
	invokeCoilErrorItem = item("CoilErr", OPTIONTYPE_STRING, OPTIONACCESS_MODIFIABLE, invokeCoilErrorOption, getAscOn);
	...
	invokeSprungErrorItem = item("SprErr", OPTIONTYPE_STRING, OPTIONACCESS_MODIFIABLE, invokeSprungErrorOption, getAscOn);
	...
	invokeUnsprungErrorItem = item("UnsprErr", OPTIONTYPE_STRING, OPTIONACCESS_MODIFIABLE, invokeUnsprungErrorOption, getAscOn);
	...
	invokeSpeedErrorItem = item("speedErr", OPTIONTYPE_STRING, OPTIONACCESS_MODIFIABLE, invokeSpeedErrorOption, getAscOn);
	...
	involePowerErrorItem = item("PowErr", OPTIONTYPE_STRING, OPTIONACCESS_MODIFIABLE, involePowerErrorOption, getAscOn);
	...
	invokeWatchdogErrorItem = item("DogErr", OPTIONTYPE_STRING, OPTIONACCESS_MODIFIABLE, invokeWatchdogErrorOption, getAscOn);
